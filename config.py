...
# Runtime power diagnostics
PWR_DIAG_WINDOW_MS = 60000
PWR_DIAG_BAD_SCORE = 8
PWR_DIAG_RECOVER_SCORE_WEIGHT = 2
PWR_DIAG_I2C_ERR_WEIGHT = 1
PWR_DIAG_LOG_EVERY_MS = 10000
EVENT_RECORDER_MAX = 50
EVENTS_CMD_LIMIT = 10
DIAG_CMD_EVENTS_LIMIT = 3
SCD_RECOVERY_WINDOW_MS = 300000
SCD_RECOVERY_MAX_ATTEMPTS = 5
